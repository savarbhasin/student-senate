...
const updates = [
  {
    ...
    date: '2024-03-18',
    type: 'urgent',
    content: 'Emergency session to discuss campus response to recent developments.'
  },
  {
    id: 2,
    ...
    date: '2024-03-15',
    type: 'info',
    content: 'Deadline for new proposal submissions has been extended to March 25th.'
  }
];
  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pt-[8rem]">
      <div className="grid gap-8 md:grid-cols-2">
        <div>
          <h2 className="text-2xl font-bold mb-6 text-black">Upcoming Meetings</h2>
                ...
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-semibold flex items-center">
                    <AlertCircle className={`h-5 w-5 mr-2 ${
                      update.type === 'urgent' ? 'text-red-500' : 'text-blue-500'
                    }`} />
                    {update.title}
                  </h3>
