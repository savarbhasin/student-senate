        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300">
              Representing and advocating for students since 1950. Working
              together to create positive change on campus.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="#meetings" className="text-gray-300 hover:text-white">
                  Meetings
                </a>
              </li>
              <li>
